                      ...
                      absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                    ...
                                    fluidRow(
                                      column(10, offset = 1,
                                             ...
                                             checkboxInput(inputId="input_checkbox",label = "Could you please do us a favor?(Checking means you agree to return the bike to a nearby station with bike shortage and you will get a bonus!)", value = FALSE),
