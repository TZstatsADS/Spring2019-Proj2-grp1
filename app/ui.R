...
ui <- navbarPage("Citi Bike Helper", id="nav",
           ...
           tabPanel("Bike User", value = "b",
                    bootstrapPage(
                      ...
                      absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                    ...
                                    width = 300, height = "auto",
                                    h4("Find Citi Bike Stations",align = "center"),
                                    ...
                                    fluidRow(
                                      column(10, offset = 1,
                                             ...
                                             checkboxInput(inputId="input_checkbox",label = "Could you help us return the bike to a nearby station with bike shortage?", value = FALSE),
                                             conditionalPanel(condition="input.input_checkbox==true",
                                                              textInput(inputId = "enter_email", label = "Enter E-mail address to receive bonus")),
           ...
           tabPanel("About",value="d",
                    fluidPage(
                      ...
                      br(),
                      h2("Introduction:"),
                      h3("This application mainly focuses on bringing convinence to bike users, and supporting business operations"),
                      h3("Features:"),
                      h4("1. Help bike users figure out the current bike station status"),
                      h4("2. Offer bike users the best closest available bike stations"),
                      h4("3. Give bike users bonus to encourage them to return bikes to the station with bike shortage"),
                      h4("4. Present popular bike stations plot to help business with advertising"),
                      h4("5. Provide updated empty bike stations to Citi bike"),
                      br(),
